 ...
 * item_current_prices' openskin columns. Pulled separately from [de.nogaemer.cs2skinsv2.catalog.model.Skin]
...
object RatingCalculator {
     ...
     *   indexed the same as [TradeUp.outcomeProbabilities]
     */
    fun calculate(
        tradeUp: TradeUp,
    ...
    private fun weightedGeometricMean(componentsAndWeights: List<Pair<Double, Double>>): Double {
        ...
        val logSum = componentsAndWeights.sumOf { (value, weight) ->
            weight * ln(value.coerceIn(1e-9, 1.0))
        }
