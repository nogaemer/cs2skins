package de.nogaemer.cs2skinsv2.tradeup.service
...
import de.nogaemer.cs2skinsv2.tradeup.model.TradeUp
...
import de.nogaemer.cs2skinsv2.tradeup.model.TradeUpOutput
import de.nogaemer.cs2skinsv2.tradeup.repository.*
...
class TradeUpOptimizer(
    ...
    fun optimizeAll() {
        ...
        val totalPersisted = AtomicLong(0)
    ...
    fun optimize(
                    ...
                    itemsA.forEach { itemA ->
                        itemsB.forEach { itemB ->
                            ...
                            if (tradeUp.roiWithDropChange.isFinite() &&
                                ...
                                val wearBucketId = wearBucketIdByCswear[CSWear.Companion.floatToCSWear(outputFloat)]
                                ...
                                if (skin1ItemId != null && skin2ItemId != null && wearBucketId != null) {
                                    ...
                                    val skin1WearBucketIdRaw =
                                        wearBucketIdByCswear[CSWear.Companion.floatToCSWear(costsFloatInput.floatA)]
                                            ?: return@forEach
                                    val skin2WearBucketIdRaw =
                                        wearBucketIdByCswear[CSWear.Companion.floatToCSWear(costsFloatInput.floatB)]
                                            ?: return@forEach
        ...
        pendingCandidates.forEach { candidate ->
            ...
            val outputMetricsList = tradeUpOutput.skins.map { outcomeSkin ->
                ...
                val outWearBucketId = outFloat?.let { wearBucketIdByCswear[CSWear.Companion.floatToCSWear(it)] }
            ...
            tradeUpOutput.skins.forEachIndexed { index, outcomeSkin ->
                ...
                val outWear = CSWear.Companion.floatToCSWear(outFloat)
    ...
    private fun calculateTradeUpOutput(outputItems: MutableList<Item>, avgFloat: Double): TradeUpOutput {
        ...
        return TradeUpOutput(
            skins = skins,
            costs = skins.sumOf { skin -> skin.price[CSWear.Companion.floatToCSWear(skin.float!!)] ?: 0.0 }
        )
    }
