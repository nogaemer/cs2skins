            ...
            CSWear.entries.forEach { wearSkinB ->
                ...
                dropProbabilityListA.forEach { dropProbabilityA ->
                    ...
                    dropProbabilityListB.forEach { dropProbabilityB ->
                        ...
                        if ((tradeUpInputComponentA.skin.price[CSWear.Companion.floatToCSWear(costFloatInput.floatA)]
                                ?: 0.0) <= 0.0
                        ) return@forEach

                        if ((tradeUpInputComponentB.skin.price[CSWear.Companion.floatToCSWear(costFloatInput.floatB)]
                                ?: 0.0) <= 0.0
                        ) return@forEach
