...
class ItemPriceHistoryWriter(private val clickHouseClientFactory: ClickHouseClientFactory) {
        ...
        clickHouseClientFactory.query { connection: Connection ->
            ...
            connection.prepareStatement(sql).use { statement ->
                rows.forEach { row ->
                    ...
                    if (row.buyPrice == null) statement.setNull(5, java.sql.Types.DECIMAL) else statement.setBigDecimal(5, row.buyPrice)
                    if (row.sellPrice == null) statement.setNull(6, java.sql.Types.DECIMAL) else statement.setBigDecimal(6, row.sellPrice)
                    ...
                    if (row.priceImpact5Pct == null) statement.setNull(14, java.sql.Types.FLOAT) else statement.setFloat(14, row.priceImpact5Pct)
                    if (row.priceImpact10Pct == null) statement.setNull(15, java.sql.Types.FLOAT) else statement.setFloat(15, row.priceImpact10Pct)
